...
public class Schedule_Manager {
	...
	public static void main(String[] args) throws IOException{ 
		...
		Scanner scan3 = new Scanner(new File("patientInfo.data"));// data of patient's information
		Scanner scan4 = new Scanner(new File("symptom.data")); // data for patient's symptom
		...
		String contents3 = scan3.useDelimiter("\\Z").next(); // converts (patient's information) scanner files to string
		String contents4 = scan4.useDelimiter("\\Z").next();
		scan.close();
		scan2.close();
		scan3.close();
		scan4.close();
	...
	System.out.println("Patient's request: ");
	System.out.println(contents +"\n");
	System.out.println("Doctor's available schedule: ");
	...
	if (contents2.contains(contents)) {
		...
		if (k.equals("Yes")) {
			...
			System.out.println("This appointment is for" + contents3);
			System.out.println("His/Her symptom is" + contents4);
	...
	System.out.println("Patient's past appointments");
